#!/usr/bin/env python3
"""Download all PDF files linked from the freshman page.

Usage:
    python app.py --url <PAGE_URL> [--outdir docs] [--insecure]

Default URL: https://pdc.adm.ncu.edu.tw/newble_note.asp
"""
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="Download PDFs linked from the freshman page")
