...
def main(argv=None):
    parser = argparse.ArgumentParser(description="Download linked files from the course Q&A page into a docs/ folder")
    parser.add_argument("--url", required=False, help="Page URL to crawl",
                        default="https://pdc.adm.ncu.edu.tw/qa_course.asp")
