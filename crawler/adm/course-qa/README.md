# Course Q&A PDF Downloader

This script (`app.py`) is designed to download PDF files linked from the National Central University (NCU) course Q&A page.
...
- `--url`: Specify the URL to crawl (default: `https://pdc.adm.ncu.edu.tw/qa_course.asp`).
