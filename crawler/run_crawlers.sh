...
CRAWLER_CMDS=(
    ...
    "python3 app.py" # oga/news
    "python3 app.py" # oga/common-qa
...
echo "Checking webdriver-manager version..."
python3 -c "import webdriver_manager; print(f'webdriver_manager version: {webdriver_manager.__version__}')"
echo
